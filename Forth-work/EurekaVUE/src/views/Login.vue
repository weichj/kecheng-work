    ...
    <div class="login-wrap">
      <el-form class="login-container">
        ...
        <el-form-item label="账号">
          <el-input type="txt" v-model="account.username" placeholder="登录账号" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="密码">
          <el-input type="password" v-model="account.password" placeholder="登录密码" autocomplete="off"></el-input>
        </el-form-item>
        <div style="display: flex;flex-flow: row;justify-content: space-around">
          ...
          <el-form-item>
            <el-button type="primary" style="width: 150px;" @click="toReg()">注册</el-button>
          </el-form-item>
        </div>
...
export default {
  ...
  methods:{
    login(name){
      const _this = this;
        axios.post('http://localhost:8010/user/users/login' , {UserName:this.account.username ,Password:this.account.password}).then(function (resp) {
          sessionStorage.setItem("token",resp.data.data.token)
          sessionStorage.setItem("username",resp.data.data.username)
          sessionStorage.setItem("identity",resp.data.data.identity)
          if (resp.data.code===200||202){
